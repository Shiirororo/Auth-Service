...
type AuthRepository interface {
	...
	GetUserByUserID(ctx context.Context, userID string) (*AuthUser, error)
}
...
func (r *authRepository) FindByUsername(ctx context.Context, username string) (*AuthUser, error) {
	var user AuthUser
...
func (r *authRepository) GetUserByUserID(ctx context.Context, userID string) (*AuthUser, error) {
	var user AuthUser
	err := r.db.
		WithContext(ctx).
		Where("id = ?", userID).
